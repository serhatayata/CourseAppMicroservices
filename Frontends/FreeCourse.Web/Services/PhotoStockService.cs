...
namespace FreeCourse.Web.Services
{
    public class PhotoStockService : IPhotoStockService
    {
        ...
        public async Task<PhotoViewModel> UploadPhoto(IFormFile photo)
        {
            ...
            //string photo bizim IFormFile ile gelen datanın ismi
            multipartContent.Add(new ByteArrayContent(ms.ToArray()), "photo", randonFilename);

            //post edildiğinde diğer tarafta returnPath kısmının başına /photos eklenmesi için burada "photos" ile belirttik..
